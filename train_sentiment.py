# Run with: accelerate launch --config_file accelerate.cfg train_sentiment.py
...
def collate_fn(items):
    ...
    output = tokenizer(texts, return_tensors='pt', padding=True, max_length=max_length, truncation=True)
